...
gmsh -setnumber size 6.4 -setnumber blratio 4 -setnumber blratiocorner 2  -setnumber isofac 2 -setnumber injectorfac 5 -setnumber blratioinjector 3 -o actii_3d.msh -nopopup -format msh2 ./actii_from_brep.geo -3 -nt $NCPUS
