...
num_bl_nozzle_thickness = 8;

//
// nozzle bl
//
// the vertical segments
Transfinite Curve{1247, 1245, 1249, 1252, 1255, 1258, 1261} = num_bl_nozzle_thickness Using Progression 1.1;
// upstream
...
//
// transfinite bl meshing
num_bl_model_thickness = 8;

// the inner vertical segments
Transfinite Curve{1224, 1222, 1226, 1233, 1235} = num_bl_model_thickness Using Progression 1.1;
// the outer vertical segments
Transfinite Curve{-1221, -1219, -1230} = num_bl_model_thickness Using Progression 1.1;
Transfinite Curve{-1274} = num_bl_model_thickness Using Progression 1.4;
// tip
...
Transfinite Curve{1261} = 8 Using Progression 1.0;
Transfinite Curve{1272} = 8 Using Progression 1.0;
