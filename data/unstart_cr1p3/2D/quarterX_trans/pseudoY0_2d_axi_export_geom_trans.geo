...
nozzle_bl_thickness = 3.5;
model_bl_thickness = 5.0;
outer_bl_thickness = 5.0;
// nozzle
Translate {0., nozzle_bl_thickness,  0.} { Duplicata{ Line{1:2, 21:24}; } }
// inside model
Translate {0., model_bl_thickness,  0.} { Duplicata{ Line{25:27}; } }
// outside model
Translate {0., -outer_bl_thickness,  0.} { Duplicata{ Line{29}; } }
// model tip
