...
Physical Curve("injection") = {11}; // injection
Physical Curve("flow") = {2, 25, 11}; // all inflow/outflow
Physical Curve('isothermal_wall') = {
    1, // inflow top
    3, // inflow bottom
    4, // inflow bottom ramp
    5, // inflow bottom transition
    6, // isolator/nozzle bottom
    7, // cavity front
    8, // cavity bottom
...
Field[17] = Distance;
Field[17].CurvesList = {
    14, 17, // cavity surround
    15, 16, // cavity sample
    20, 22, // combustor surround
    21 // combustor sample
};
