...
Physical Curve('isothermal_wall') = {
    ...
    16, // throat top
    17, // converging nozzle curve top
    18, // converging nozzle slant top
    19, // knife horizontal top
    20, // knife curve lower top
    21, // knife vertical top
    22, // knife curve upper top
    23, // inlet sponge top
    25, // inlet sponge bottom
    26, // knife curve lower bottom
    27, // knife vertical bottom
    28, // knife curve upper bottom
    29, // knife horizontal bottom
    30, // converging nozzle slant bottom
    31, // converging nozzle curve bottom
    32, // throat bottom
    33 // converging nozzle curve bottom
};
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
HAVENT EDITED THE MESH FIELDS YET
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
Field[1].CurvesList = {
    ...
    13, // converging nozzle slant top
    14, // fillet inlet sponge top
    15, // inlet sponge top
    17, // inlet sponge bottom
    18, // fillet inlet sponge bottom
    19, // converging nozzle slant bottom
    20 // converging nozzle curve bottom
};
