...
class Thermochemistry:
    ...
    def get_species_specific_heats_r(self, temperature):
        return self._pyro_make_array([
            self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 5.646848034499998, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 3.3372792 + -4.94024731e-05*temperature + 4.99456778e-07*temperature**2 + -1.79566394e-10*temperature**3 + 2.00255376e-14*temperature**4, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 2.34433112 + 0.00798052075*temperature + -1.9478151e-05*temperature**2 + 2.01572094e-08*temperature**3 + -7.37611761e-12*temperature**4, 3.4699518561589993))),
            self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 2.500000017962688, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 2.50000001 + -2.30842973e-11*temperature + 1.61561948e-14*temperature**2 + -4.73515235e-18*temperature**3 + 4.98197357e-22*temperature**4, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 2.5 + 7.05332819e-13*temperature + -1.99591964e-15*temperature**2 + 2.30081632e-18*temperature**3 + -9.27732332e-22*temperature**4, 2.5000000000865743))),
            self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 4.387766064999996, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 3.28253784 + 0.00148308754*temperature + -7.57966669e-07*temperature**2 + 2.09470555e-10*temperature**3 + -2.16717794e-14*temperature**4, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 3.78245636 + -0.00299673416*temperature + 9.84730201e-06*temperature**2 + -9.68129509e-09*temperature**3 + 3.24372837e-12*temperature**4, 3.5345725252670004))),
            self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 2.70374976525, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 2.56942078 + -8.59741137e-05*temperature + 4.19484589e-08*temperature**2 + -1.00177799e-11*temperature**3 + 1.22833691e-15*temperature**4, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 3.1682671 + -0.00327931884*temperature + 6.64306396e-06*temperature**2 + -6.12806624e-09*temperature**3 + 2.11265971e-12*temperature**4, 2.634001959571))),
            self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 4.65294151, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 2.86472886 + 0.00105650448*temperature + -2.59082758e-07*temperature**2 + 3.05218674e-11*temperature**3 + -1.33195876e-15*temperature**4, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 4.12530561 + -0.00322544939*temperature + 6.52764691e-06*temperature**2 + -5.79853643e-09*temperature**3 + 2.06237379e-12*temperature**4, 3.6053037589890002))),
            self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 6.911370612500001, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 4.0172109 + 0.00223982013*temperature + -6.3365815e-07*temperature**2 + 1.1424637e-10*temperature**3 + -1.07908535e-14*temperature**4, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 4.30179801 + -0.00474912051*temperature + 2.11582891e-05*temperature**2 + -2.42763894e-08*temperature**3 + 9.29225124e-12*temperature**4, 4.201112597243999))),
            self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 9.575760487499991, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 4.16500285 + 0.00490831694*temperature + -1.90139225e-06*temperature**2 + 3.71185986e-10*temperature**3 + -2.87908305e-14*temperature**4, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 4.27611269 + -0.000542822417*temperature + 1.67335701e-05*temperature**2 + -2.15770813e-08*temperature**3 + 8.62454363e-12*temperature**4, 5.106564882203))),
            self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 8.199083365000002, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 3.03399249 + 0.00217691804*temperature + -1.64072518e-07*temperature**2 + -9.7041987e-11*temperature**3 + 1.68200992e-14*temperature**4, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 4.19864056 + -0.0020364341*temperature + 6.52040211e-06*temperature**2 + -5.48797062e-09*temperature**3 + 1.77197817e-12*temperature**4, 4.040724336336999))),
            self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 4.555077125000001, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 2.92664 + 0.0014879768*temperature + -5.68476e-07*temperature**2 + 1.0097038e-10*temperature**3 + -6.753351e-15*temperature**4, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 3.298677 + 0.0014082404*temperature + -3.963222e-06*temperature**2 + 5.641515e-09*temperature**3 + -2.444854e-12*temperature**4, 3.4969767276))),
                ])

    def get_species_enthalpies_rt(self, temperature):
        return self._pyro_make_array([
            self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 5.646848034499998 + -7846.122987416657 / temperature, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 3.3372792 + -2.470123655e-05*temperature + 1.6648559266666665e-07*temperature**2 + -4.48915985e-11*temperature**3 + 4.00510752e-15*temperature**4 + -950.158922 / temperature, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 2.34433112 + 0.003990260375*temperature + -6.4927169999999995e-06*temperature**2 + 5.03930235e-09*temperature**3 + -1.4752235220000002e-12*temperature**4 + -917.935173 / temperature, 3.4699518561589993 + -1034.5677632211598 / temperature))),
            self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 2.500000017962688 + 25473.659816313415 / temperature, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 2.50000001 + -1.154214865e-11*temperature + 5.385398266666667e-15*temperature**2 + -1.1837880875e-18*temperature**3 + 9.96394714e-23*temperature**4 + 25473.6599 / temperature, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 2.5 + 3.526664095e-13*temperature + -6.653065466666667e-16*temperature**2 + 5.7520408e-19*temperature**3 + -1.855464664e-22*temperature**4 + 25473.6599 / temperature, 2.5000000000865743 + 25473.659899992013 / temperature))),
            self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 4.387766064999996 + -473.0370429166486 / temperature, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 3.28253784 + 0.00074154377*temperature + -2.526555563333333e-07*temperature**2 + 5.236763875e-11*temperature**3 + -4.33435588e-15*temperature**4 + -1088.45772 / temperature, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 3.78245636 + -0.00149836708*temperature + 3.282434003333333e-06*temperature**2 + -2.4203237725e-09*temperature**3 + 6.48745674e-13*temperature**4 + -1063.94356 / temperature, 3.5345725252670004 + -1053.8338992595302 / temperature))),
            self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 2.70374976525 + 28421.54266604166 / temperature, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 2.56942078 + -4.298705685e-05*temperature + 1.3982819633333334e-08*temperature**2 + -2.504444975e-12*temperature**3 + 2.4566738199999997e-16*temperature**4 + 29217.5791 / temperature, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 3.1682671 + -0.00163965942*temperature + 2.2143546533333334e-06*temperature**2 + -1.53201656e-09*temperature**3 + 4.22531942e-13*temperature**4 + 29122.2592 / temperature, 2.634001959571 + 29183.37438845176 / temperature))),
            self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 4.65294151 + 1125.5531295833343 / temperature, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 2.86472886 + 0.00052825224*temperature + -8.636091933333334e-08*temperature**2 + 7.63046685e-12*temperature**3 + -2.66391752e-16*temperature**4 + 3718.85774 / temperature, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 4.12530561 + -0.001612724695*temperature + 2.1758823033333334e-06*temperature**2 + -1.4496341075e-09*temperature**3 + 4.1247475799999997e-13*temperature**4 + 3381.53812 / temperature, 3.6053037589890002 + 3440.40255233449 / temperature))),
            self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 6.911370612500001 + -1656.9012661666616 / temperature, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 4.0172109 + 0.001119910065*temperature + -2.1121938333333332e-07*temperature**2 + 2.85615925e-11*temperature**3 + -2.1581707e-15*temperature**4 + 111.856713 / temperature, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 4.30179801 + -0.002374560255*temperature + 7.0527630333333326e-06*temperature**2 + -6.06909735e-09*temperature**3 + 1.8584502480000002e-12*temperature**4 + 294.80804 / temperature, 4.201112597243999 + 257.08418834444 / temperature))),
            self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 9.575760487499991 + -22782.749970833283 / temperature, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 4.16500285 + 0.00245415847*temperature + -6.337974166666666e-07*temperature**2 + 9.27964965e-11*temperature**3 + -5.7581661e-15*temperature**4 + -17861.7877 / temperature, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 4.27611269 + -0.0002714112085*temperature + 5.5778567000000005e-06*temperature**2 + -5.394270325e-09*temperature**3 + 1.724908726e-12*temperature**4 + -17702.5821 / temperature, 5.106564882203 + -17865.04469695422 / temperature))),
            self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 8.199083365000002 + -40104.879360416664 / temperature, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 3.03399249 + 0.00108845902*temperature + -5.469083933333333e-08*temperature**2 + -2.426049675e-11*temperature**3 + 3.36401984e-15*temperature**4 + -30004.2971 / temperature, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 4.19864056 + -0.00101821705*temperature + 2.17346737e-06*temperature**2 + -1.371992655e-09*temperature**3 + 3.54395634e-13*temperature**4 + -30293.7267 / temperature, 4.040724336336999 + -30289.559707525976 / temperature))),
            self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 4.555077125000001 + -2595.995825000008 / temperature, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 2.92664 + 0.0007439884*temperature + -1.8949200000000001e-07*temperature**2 + 2.5242595e-11*temperature**3 + -1.3506701999999999e-15*temperature**4 + -922.7977 / temperature, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 3.298677 + 0.0007041202*temperature + -1.3210739999999999e-06*temperature**2 + 1.41037875e-09*temperature**3 + -4.889707999999999e-13*temperature**4 + -1020.8999 / temperature, 3.4969767276 + -1042.4521294489998 / temperature))),
                ])

    def get_species_entropies_r(self, temperature):
        return self._pyro_make_array([
                self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 5.646848034499998*self.usr_np.log(temperature) + -18.217821210543857, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 3.3372792*self.usr_np.log(temperature) + -4.94024731e-05*temperature + 2.49728389e-07*temperature**2 + -5.985546466666667e-11*temperature**3 + 5.0063844e-15*temperature**4 + -3.20502331, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 2.34433112*self.usr_np.log(temperature) + 0.00798052075*temperature + -9.7390755e-06*temperature**2 + 6.7190698e-09*temperature**3 + -1.8440294025e-12*temperature**4 + 0.683010238, 3.4699518561589993*self.usr_np.log(temperature) + -7.795962061573563))),
                self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 2.500000017962688*self.usr_np.log(temperature) + 5.094731879256518, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 2.50000001*self.usr_np.log(temperature) + -2.30842973e-11*temperature + 8.0780974e-15*temperature**2 + -1.5783841166666668e-18*temperature**3 + 1.2454933925e-22*temperature**4 + -0.446682914, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 2.5*self.usr_np.log(temperature) + 7.05332819e-13*temperature + -9.9795982e-16*temperature**2 + 7.669387733333333e-19*temperature**3 + -2.31933083e-22*temperature**4 + -0.446682853, 2.5000000000865743*self.usr_np.log(temperature) + 84.91219966631347))),
                self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 4.387766064999996*self.usr_np.log(temperature) + -6.348555259014354, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 3.28253784*self.usr_np.log(temperature) + 0.00148308754*temperature + -3.789833345e-07*temperature**2 + 6.982351833333333e-11*temperature**3 + -5.41794485e-15*temperature**4 + 5.45323129, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 3.78245636*self.usr_np.log(temperature) + -0.00299673416*temperature + 4.923651005e-06*temperature**2 + -3.2270983633333334e-09*temperature**3 + 8.109320925e-13*temperature**4 + 3.65767573, 3.5345725252670004*self.usr_np.log(temperature) + -2.669057824443424))),
                self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 2.70374976525*self.usr_np.log(temperature) + 4.568415215523018, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 2.56942078*self.usr_np.log(temperature) + -8.59741137e-05*temperature + 2.097422945e-08*temperature**2 + -3.3392599666666663e-12*temperature**3 + 3.070842275e-16*temperature**4 + 4.78433864, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 3.1682671*self.usr_np.log(temperature) + -0.00327931884*temperature + 3.32153198e-06*temperature**2 + -2.0426887466666666e-09*temperature**3 + 5.281649275e-13*temperature**4 + 2.05193346, 2.634001959571*self.usr_np.log(temperature) + 99.38579724408474))),
                self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 4.65294151*self.usr_np.log(temperature) + -11.379167215634386, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 2.86472886*self.usr_np.log(temperature) + 0.00105650448*temperature + -1.29541379e-07*temperature**2 + 1.01739558e-11*temperature**3 + -3.3298969e-16*temperature**4 + 5.70164073, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 4.12530561*self.usr_np.log(temperature) + -0.00322544939*temperature + 3.263823455e-06*temperature**2 + -1.9328454766666666e-09*temperature**3 + 5.155934475e-13*temperature**4 + -0.69043296, 3.6053037589890002*self.usr_np.log(temperature) + 13.51586995092341))),
                self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 6.911370612500001*self.usr_np.log(temperature) + -18.275177723284507, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 4.0172109*self.usr_np.log(temperature) + 0.00223982013*temperature + -3.16829075e-07*temperature**2 + 3.808212333333334e-11*temperature**3 + -2.697713375e-15*temperature**4 + 3.78510215, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 4.30179801*self.usr_np.log(temperature) + -0.00474912051*temperature + 1.057914455e-05*temperature**2 + -8.0921298e-09*temperature**3 + 2.32306281e-12*temperature**4 + 3.71666245, 4.201112597243999*self.usr_np.log(temperature) + 0.8846973200588657))),
                self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 9.575760487499991*self.usr_np.log(temperature) + -37.915128591143336, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 4.16500285*self.usr_np.log(temperature) + 0.00490831694*temperature + -9.50696125e-07*temperature**2 + 1.2372866199999999e-10*temperature**3 + -7.197707625e-15*temperature**4 + 2.91615662, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 4.27611269*self.usr_np.log(temperature) + -0.000542822417*temperature + 8.36678505e-06*temperature**2 + -7.192360433333333e-09*temperature**3 + 2.1561359075e-12*temperature**4 + 3.43505074, 5.106564882203*self.usr_np.log(temperature) + -63.331890761376556))),
                self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 8.199083365000002*self.usr_np.log(temperature) + -42.57452815359615, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 3.03399249*self.usr_np.log(temperature) + 0.00217691804*temperature + -8.2036259e-08*temperature**2 + -3.2347329e-11*temperature**3 + 4.2050248e-15*temperature**4 + 4.9667701, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 4.19864056*self.usr_np.log(temperature) + -0.0020364341*temperature + 3.260201055e-06*temperature**2 + -1.82932354e-09*temperature**3 + 4.429945425e-13*temperature**4 + -0.849032208, 4.040724336336999*self.usr_np.log(temperature) + -100.44168482584284))),
                self.usr_np.where(self.usr_np.greater(temperature, 5000.0), 4.555077125000001*self.usr_np.log(temperature) + -10.568451060782778, self.usr_np.where(self.usr_np.greater(temperature, 1000.0), 2.92664*self.usr_np.log(temperature) + 0.0014879768*temperature + -2.84238e-07*temperature**2 + 3.3656793333333334e-11*temperature**3 + -1.68833775e-15*temperature**4 + 5.980528, self.usr_np.where(self.usr_np.greater(temperature, 300.0), 3.298677*self.usr_np.log(temperature) + 0.0014082404*temperature + -1.981611e-06*temperature**2 + 1.8805050000000002e-09*temperature**3 + -6.112135e-13*temperature**4 + 3.950372, 3.4969767276*self.usr_np.log(temperature) + -4.244108242030649))),
                ])
